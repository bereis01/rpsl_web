...
from . import cleaning, parsing, analysis
...
parser.add_argument("-c", "--cleaning", action="store_true")
...
# Function for cleaning rpslyzers output
def clean():
    # Reads the data
    f = open(rpslyzer_output_path)
    data = json.load(f)
    f.close()
